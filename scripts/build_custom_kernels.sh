...
g++ -std=c++11 -shared srl_kernels.cc -o srl_kernels.so -I $TF_INC -I$TF_INC/external/nsync/public -L $TF_LIB -l tensorflow_framework -f PIC -O2 -D_GLIBCXX_USE_CXX11_ABI=0
